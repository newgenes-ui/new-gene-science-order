    ...
    <div className="min-h-screen bg-gray-100 py-10 print:py-0 print:bg-white flex flex-col items-center">
      ...
      <div className="w-full max-w-[800px] flex justify-between items-center mb-4 print:hidden px-4">
        ...
        <div className="flex gap-3">
          <button onClick={handleDownloadPDF} disabled={isDownloading} className="flex items-center gap-2 bg-[#2D5A27] text-white px-5 py-2.5 rounded-lg font-bold shadow-lg disabled:opacity-70 text-xs">
            {isDownloading ? <Loader2 className="w-5 h-5 animate-spin" /> : <Download className="w-5 h-5" />}
            PDF 다운로드
          </button>
          <button onClick={() => window.print()} className="flex items-center gap-2 bg-slate-800 text-white px-5 py-2.5 rounded-lg font-bold shadow-lg text-xs">
      ...
      <div ref={quoteRef} id="quote-container" className="w-[800px] bg-white p-10 shadow-2xl print:shadow-none text-black font-sans aspect-[1/1.414] print:overflow-visible overflow-hidden text-[12px] leading-tight border border-gray-200 print:border-none">
        <div className="text-center text-4xl font-black tracking-[1em] mb-4 leading-normal">견 적 서</div>
