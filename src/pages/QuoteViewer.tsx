...
export default function QuoteViewer() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 print:py-0 print:bg-white flex flex-col items-center">
      ...
      >
        {/* 견적일자 */}
        <div style={{ position: 'absolute', top: '135px', left: '104px', width: '282px', height: '22px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>
          {todayStr}
        </div>
        
        {/* 견적번호 */}
        <div style={{ position: 'absolute', top: '159px', left: '104px', width: '282px', height: '22px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>
          {quoteNo}
        </div>

        {/* 수신 */}
        <div style={{ position: 'absolute', top: '183px', left: '104px', width: '282px', height: '22px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '13px' }}>
          {clientName}
        </div>

        {/* 담당자 */}
        <div style={{ position: 'absolute', top: '207px', left: '104px', width: '282px', height: '22px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>
          {ordererName} 귀하
        </div>

        {/* 합계금액 한글 */}
        <div style={{ position: 'absolute', top: '346px', left: '92px', width: '462px', height: '24px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'black', fontSize: '14px', letterSpacing: '0.1em' }}>
          {totalAmountKorean} 원정
        </div>

        {/* 합계금액 숫자 */}
        <div style={{ position: 'absolute', top: '346px', left: '556px', width: '142px', height: '24px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'right', fontWeight: 'bold', fontSize: '12px', paddingRight: '4px' }}>
        ...
        {/* 집계표 오버레이 */}
        {/* 금액 */}
        <div style={{ position: 'absolute', top: '833px', left: '654px', width: '115px', height: '22px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'right', paddingRight: '4px', fontWeight: 'bold' }}>
          {totalSubtotal.toLocaleString()}
        </div>
        {/* 부가세 */}
        <div style={{ position: 'absolute', top: '858px', left: '654px', width: '115px', height: '22px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'right', paddingRight: '4px', fontWeight: 'bold' }}>
          {totalVat.toLocaleString()}
        </div>
        {/* 합계 */}
        <div style={{ position: 'absolute', top: '883px', left: '654px', width: '115px', height: '22px', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'right', paddingRight: '4px', fontWeight: 'bold', color: '#B91C1C', fontSize: '13px' }}>
          {totalAmount.toLocaleString()}
        </div>
      </div>
