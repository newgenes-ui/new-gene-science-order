    ...
    try {
      ...
      const res = await fetch(functionUrl, {
        ...
        body: JSON.stringify({
          ...
          subject: subject,
          html: htmlContent,
          pdfBase64: '', // 초경량 1KB 가상 PDF 데이터
          fileName: `거래명세서_상세내역_${finalClientName}.pdf`
        })
      });
